...
public class ShoppingProductAdvDetails extends AppCompatActivity {
    ...
    private void initComponent() {
        ...
        findViewById(R.id.fab_qty_sub).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.fab_qty_add).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int qty = Integer.parseInt(tv_qty.getText().toString());
                if (qty < 10) {
        ...
        findViewById(R.id.bt_add_to_wishlist).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void setSize(View v) {
        ...
        for (int id : array_size_bt) {
            if (v.getId() != id) {
                Button bt_unselect = findViewById(id);
