...
import com.edulytica.app.model.Event;
...
public class DialogCustom extends AppCompatActivity {
    ...
    private void showCustomDialog() {
        ...
        final Button spn_from_date = dialog.findViewById(R.id.spn_from_date);
        final Button spn_from_time = dialog.findViewById(R.id.spn_from_time);
        final Button spn_to_date = dialog.findViewById(R.id.spn_to_date);
        final Button spn_to_time = dialog.findViewById(R.id.spn_to_time);
        final TextView tv_email = dialog.findViewById(R.id.tv_email);
        final EditText et_name = dialog.findViewById(R.id.et_name);
        final EditText et_location = dialog.findViewById(R.id.et_location);
        final AppCompatCheckBox cb_allday = dialog.findViewById(R.id.cb_allday);
        final AppCompatSpinner spn_timezone = dialog.findViewById(R.id.spn_timezone);
