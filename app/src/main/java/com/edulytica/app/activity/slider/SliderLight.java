...
public class SliderLight extends AppCompatActivity {
    ...
    private void initComponent() {
        // light theme
        seekbar_accent_light = findViewById(R.id.seekbar_accent_light);
        ...
        seekbar_primary_light = findViewById(R.id.seekbar_primary_light);
        ...
        seekbar_accent_light_outline = findViewById(R.id.seekbar_accent_light_outline);
        ...
        seekbar_primary_light_outline = findViewById(R.id.seekbar_primary_light_outline);
