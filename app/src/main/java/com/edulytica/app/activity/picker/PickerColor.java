...
package com.edulytica.app.activity.picker;
...
public class PickerColor extends AppCompatActivity {
    ...
    private void initComponent() {
        findViewById(R.id.bt_pick_color).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void showColorPickerDialog() {
        ...
        final View view_result = dialog.findViewById(R.id.view_result);
        final AppCompatSeekBar seekbar_red = dialog.findViewById(R.id.seekbar_red);
        final AppCompatSeekBar seekbar_green = dialog.findViewById(R.id.seekbar_green);
        final AppCompatSeekBar seekbar_blue = dialog.findViewById(R.id.seekbar_blue);

        final TextView tv_red = dialog.findViewById(R.id.tv_red);
        final TextView tv_green = dialog.findViewById(R.id.tv_green);
        final TextView tv_blue = dialog.findViewById(R.id.tv_blue);
