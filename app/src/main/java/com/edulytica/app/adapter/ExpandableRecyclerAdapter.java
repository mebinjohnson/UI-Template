...
public abstract class ExpandableRecyclerAdapter<T extends ExpandableRecyclerAdapter.ListItem> extends RecyclerView.Adapter<ExpandableRecyclerAdapter.ViewHolder> {
    public static final int NORMAL = MenuType.NORMAL.getValue();
    public static final int HEADER = MenuType.HEADER.getValue();
    public static final int SUB_HEADER = MenuType.SUB_HEADER.getValue();
    public static final int DIVIDER = MenuType.DIVIDER.getValue();
